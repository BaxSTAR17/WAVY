...
<template>
    <div class="bg-neutral-300 dark:bg-neutral-800 w-full min-h-full flex flex-col lg:hidden" v-show="guestMode === false">
    ...
    <div class="bg-neutral-300 dark:bg-neutral-800 w-full min-h-full flex lg:hidden flex-col justify-center items-center" v-show="guestMode === true">
