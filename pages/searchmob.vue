...
<template>
    <div class="bg-neutral-800 w-full min-h-full block lg:hidden">
        <UCommandPalette :groups="groups"/>
    </div>
    <div class="bg-neutral-800 w-full min-h-full hidden lg:flex flex-col justify-center items-center">
