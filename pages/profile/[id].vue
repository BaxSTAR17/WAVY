                ...
                <div class="w-full flex flex-col h-40 justify-evenly items-start">
                    ...
                    <div class="flex flex-row gap-3">
                        <span class="pr-3 pl-3 text-white w-content tracking-widest bg-purple-800 hover:bg-purple-900 rounded-2xl">
                            ...
                            <button class="w-content pt-3 pb-3 cursor-pointer flex items-center" v-if="subscribed === true && user && selfProfile === false" @click="subscribed = false; subscribe()"><UIcon name="i-uil-user-minus" size="25"/>UNSUBSCRIBE</button>
                            </UTooltip>
                        </span>
                    </div>
                </div>
